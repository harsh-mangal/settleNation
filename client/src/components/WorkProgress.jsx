        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {steps.map((s, i) => (
            <div
              ...
              "
            >
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-orange-50 mb-4">
                {s.icon}
              </div>
