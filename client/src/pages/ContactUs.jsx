                        ...
                        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
                            ...
                            >
                                <motion.h1
                                    ...
                                    className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-black text-white drop-shadow-2xl leading-tight"
                                >
                                    Contact
                                ...
                                <motion.p
                                    variants={itemVariants}
                                    className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-100 leading-relaxed max-w-4xl mx-auto drop-shadow-lg"
                                >
        ...
        <div className="w-full bg-gradient-to-b from-gray-50 to-white overflow-hidden">
            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                    ...
                    >
                        <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-orange-100 to-orange-50 rounded-full px-4 sm:px-6 py-2 sm:py-3 shadow-lg">
                            <UserCheck className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600" />
                            <span className="text-orange-700 font-bold text-base sm:text-lg">Get in Touch</span>
                        </div>
                        ...
                        <motion.div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-gray-700 leading-relaxed">
                            <motion.p variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                                We’re here to help you succeed in your visa, job, or admission interviews. Reach out to our <span className="font-bold text-orange-600">expert team</span> for personalized support.
                            </motion.p>
                            <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.2 }} className="space-y-3 sm:space-y-4">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <span className="text-sm sm:text-base">settlenation.in@gmail.com</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600" />
                                    <span className="text-sm sm:text-base">+91 7347045972</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600" />
                                    <span className="text-sm sm:text-base">SCO 363, Top Floor, Sector 44-D, Chandigarh</span>
                                </div>
                            </motion.div>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        <motion.div
                            className="bg-white/90 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl border-4 border-white/80"
                            variants={itemVariants}
                        >
                            ...
                            <div className="relative">
                                <div className="absolute -inset-4 sm:-inset-6 bg-gradient-to-br from-orange-200/40 to-orange-100/20 rounded-3xl blur-2xl"></div>
                                <div className="relative space-y-4 sm:space-y-6">
                                    <motion.input
                                        ...
                                        className="w-full p-3 sm:p-4 rounded-xl border border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/30 outline-none transition-all text-sm sm:text-base"
                                        variants={itemVariants}
                                    ...
                                    <motion.button
                                        ...
                                        className="group bg-gradient-to-r from-orange-500 via-orange-600 to-red-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl shadow-2xl font-bold text-base sm:text-lg flex items-center justify-center space-x-3 relative overflow-hidden w-full"
                                        whileHover={{
                                            scale: 1.05,
            ...
            {/* Map Section */}
            <section className="relative w-full py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-orange-50">
                <motion.div
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
                ...
                >
                    <motion.h2
                        variants={itemVariants}
                        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 text-center mb-8 sm:mb-12"
                    >
                        Find Us
                        <span className="block bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="relative w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white/80"
                    >
                        <iframe
                        ...
                        ></iframe>
                        <motion.div
                            className="absolute top-4 left-4 sm:top-6 sm:left-6 bg-white/90 backdrop-blur-md rounded-2xl p-3 sm:p-4 shadow-xl"
                    ...
                    >
                        <a
                            ...
                            className="group bg-gradient-to-r from-orange-500 via-orange-600 to-red-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl shadow-2xl font-bold text-base sm:text-lg flex items-center justify-center space-x-3 relative overflow-hidden"
                            whileHover={{
                                scale: 1.05,
                                boxShadow: "0 25px 50px rgba(255, 165, 0, 0.6)",
                            }}
                    ...
                    <motion.p
                        variants={itemVariants}
                        className="text-base sm:text-lg text-gray-600 text-center mt-4 sm:mt-8"
                    >
