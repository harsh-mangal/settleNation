...
const StudyVisa = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            color: "from-indigo-500 to-indigo-600 dark:from-indigo-700 dark:to-indigo-600",
        ...
        },
        {
            ...
            color: "from-red-500 to-red-600 dark:from-red-700 dark:to-red-600",
            bgColor: "from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/30"
        }
    ];

    const countries = [
        { name: "USA", flag: "🇺🇸", color: "from-red-500 to-blue-500 dark:from-red-700 dark:to-blue-700" },
        { name: "United Kingdom", flag: "🇬🇧", color: "from-blue-600 to-red-500 dark:from-blue-800 dark:to-red-700" },
        { name: "Canada", flag: "🇨🇦", color: "from-red-600 to-white dark:from-red-700 dark:to-gray-700" },
        { name: "Australia", flag: "🇦🇺", color: "from-blue-500 to-yellow-400 dark:from-blue-700 dark:to-yellow-600" },
        { name: "New Zealand", flag: "🇳🇿", color: "from-blue-600 to-red-500 dark:from-blue-800 dark:to-red-700" },
        { name: "Schengen", flag: "🇪🇺", color: "from-blue-600 to-yellow-400 dark:from-blue-800 dark:to-yellow-600" }
    ];
    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-900 overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
                <div className="absolute top-20 left-10 w-24 h-24 bg-gradient-to-br from-orange-200 to-orange-100 dark:from-orange-900/30 dark:to-orange-800/30 rounded-full opacity-20 animate-pulse"></div>
                <div className="absolute top-1/2 right-20 w-32 h-32 bg-gradient-to-br from-blue-200 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-full opacity-15 animate-bounce" style={{ animationDuration: '4s' }}></div>
                <div className="absolute bottom-40 left-1/3 w-20 h-20 bg-gradient-to-br from-purple-200 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-full opacity-25 animate-pulse" style={{ animationDelay: '2s' }}></div>
            </div>
            ...
            <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[100vh] text-white overflow-hidden flex items-center justify-center text-center">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
                    {/* Small Label */}
                    <FloatingCard>
                        <div className="inline-flex items-center space-x-2.5 sm:space-x-3 bg-gradient-to-r from-orange-500/20 to-orange-400/20 dark:from-orange-600/20 dark:to-orange-500/20 backdrop-blur-sm rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8 border border-white/20 dark:border-white/10">
            ...
            {/* Stats Section */}
            <div className="bg-white dark:bg-gray-800 py-20 px-4 sm:px-6 -mt-20 relative z-20">
                <div className="max-w-6xl mx-auto">
                    <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-3xl shadow-2xl p-8 sm:p-16 border border-gray-100 dark:border-gray-700">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                            {[
                                ...
                                <FloatingCard key={index} delay={index * 100}>
                                    <div className="space-y-4 p-6 rounded-2xl hover:bg-gradient-to-br hover:from-orange-50 hover:to-orange-25 dark:hover:from-orange-900/30 dark:hover:to-orange-800/30 transition-all duration-300 group">
                                        <div className="inline-flex p-3 bg-gradient-to-br from-orange-100 to-orange-50 dark:from-orange-900/50 dark:to-orange-800/50 rounded-xl group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
                                <p className="text-xl font-light">
                                    <span className="font-bold text-orange-600 dark:text-orange-400">Settle Nation</span> is recognized as the leading study visa consultants in Chandigarh. We provide expert guidance and comprehensive support to students aiming to study abroad.
                                </p>
                                <p className="text-lg">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={index} className="flex items-center space-x-3 bg-gradient-to-r from-orange-50 to-orange-50 dark:from-orange-900/50 dark:to-orange-800/50 p-4 rounded-xl border border-green-100 dark:border-green-700">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => (
                            <FloatingCard key={index} delay={index * 150}>
                                <div className={`group relative bg-gradient-to-br ${service.bgColor} p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-white/50 dark:border-gray-700/50 overflow-hidden`}>
                        ...
                        <FloatingCard delay={200}>
                            <div className="group relative overflow-hidden rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 text-white">
                                    ...
                                    <p className="text-gray-200 dark:text-gray-300">Expert guidance throughout your application process</p>
                                </div>
                                <div className="absolute top-4 right-4 z-20 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full p-2">
                        ...
                        <FloatingCard delay={400}>
                            <div className="group relative overflow-hidden rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 text-white">
                                    ...
                                    <p className="text-gray-200 dark:text-gray-300">Celebrating achievements of our successful students</p>
                                </div>
                                <div className="absolute top-4 right-4 z-20 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full p-2">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                bg: "from-purple-50 to-violet-25 dark:from-purple-900/30 dark:to-violet-800/30"
                            },
                            {
                                icon: Heart,
                                title: "Personal Care",
            ...
            <div className="relative py-32 px-4 sm:px-6 text-center text-white overflow-hidden">
                ...
                <div className="absolute inset-0">
                    {[...Array(25)].map((_, i) => (
                        <div
                            key={i}
                            className="absolute w-1 h-1 bg-white/30 dark:bg-white/20 rounded-full animate-pulse"
                            style={{
                                left: `${Math.random() * 100}%`,
                                top: `${Math.random() * 100}%`,
                ...
                <div className="relative z-10 max-w-5xl mx-auto">
                    <FloatingCard>
                        <div className="inline-flex items-center justify-center space-x-3 bg-white/10 dark:bg-gray-800/20 backdrop-blur-md rounded-full px-8 py-4 mb-8 border border-white/20 dark:border-white/10">
                            <GraduationCap className="w-6 h-6 text-orange-500 dark:text-orange-400" />
                            <span className="font-semibold text-orange-600 dark:text-orange-300 text-lg">Start Your Study Abroad Journey</span>
                            <Sparkles className="w-5 h-5 text-orange-500 dark:text-orange-400 animate-pulse" />
                        </div>
                    </FloatingCard>

                    <FloatingCard delay={200}>
                        <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-8 leading-tight text-black dark:text-white">
                            Ready to Study
                    ...
                    <FloatingCard delay={400}>
                        <p className="text-xl sm:text-2xl text-black dark:text-gray-300 mb-12 leading-relaxed font-light max-w-4xl mx-auto">
                            ...
                            <span className="text-orange-400 dark:text-orange-300 font-semibold"> study visa journey.</span>
                        </p>
                    </FloatingCard>
                    ...
                    <FloatingCard delay={800}>
                        <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-8 text-orange-500 dark:text-orange-300">
